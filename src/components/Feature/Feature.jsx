  ...
  return (
    <div className="w-full  bg-gray-900 p-6 text-white">
      ...
      <div className="flex flex-wrap justify-center group">
        ...
        <div className="flex flex-col cursor-pointer group-hover:blur-0 hover:!blur-none  hover:!scale-110 hover:bg-slate-800 w-1/4 rounded-lg  m-2 overflow-hidden sm:w-52">
