...
<div>
<h3 className="mb-6  font-semibold  uppercase text-white">Company</h3>
...
<div>
<h3 className="mb-6  font-semibold text-white uppercase ">Help center</h3>
<ul className="text-gray-500 dark:text-gray-400">
<li className="mb-2">
...
</a><li className="mb-3"><a href="#" className="hover:underline">
...
<h3 className="mb-6 font-semibold text-white uppercase ">Use Case</h3>
<ul className="text-gray-500 dark:text-gray-400">
<li className="mb-2">
<a href="#" className="hover:underline">Holidays & weekends</a>
</li>
<li className="mb-2">
<a href="#" className="hover:underline">Shared house</a>
</li>
<li className="mb-2">
<a href="#" className="hover:underline">Bachelor party</a>
</li>
<li className="mb-2">
